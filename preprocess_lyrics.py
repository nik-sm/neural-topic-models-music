...
if __name__ == "__main__":
    ...
    # NOTE the operation of taking only 100 songs happens after upsampling, so then the songs can be duplicated and the final "labels" file can have more rows than the data file.
